# 🎨 Canva Feature Graphic Creation Guide

## 📐 Quick Setup

### Step 1: Create Canva Document
...
## 🎯 Design Layout (Step-by-Step)

### Layer 1: Background (5 minutes)

1. Click "Elements" → Search "gradient"
...
4. Size: **16px**
5. Color: **Light gray (#CCCCCC)**
6. Position: Below app name, same left alignment

---

### Layer 3: App Screenshots (30 minutes)
...
4. Position at X=180, Y=25 (use ruler/grid)
5. Right-click → Effects → Add "Drop shadow" (subtle)
...
### Layer 4: Feature Icons (20 minutes)
...
[🏠 智能風水]  [📅 八字測算]  [💰 流年運程]  [❤️ 感情合盤]
  ...
  Y=440px       Y=440px       Y=440px       Y=440px
```
...
4. Size: **18px**
5. Color: **White (#FFFFFF)**
6. Add background: Rectangle with `#1A5C4A` (darker green)
7. Padding: 10px vertical, 15px horizontal
...
3. Resize to 24x24px
4. Add text below: "智能風水"
5. Group icon + text together
...
4. ❤️ **感情合盤** (Couple Analysis)

---

### Layer 5: Trust Badges (15 minutes)
...
3. Size: **14px**
4. Color: **White with 80% opacity (#FFFFFFCC)**
5. No background needed (transparent)

**Alternative:** Use gold/yellow color `#FFD700` for star rating to make it pop

---

## 📸 Element Resources in Canva
...
2. File type: **PNG**
3. Quality: **High quality** (not compressed)
...
- [ ] Not too cluttered
- [ ] Screenshots have subtle shadows
...
- [ ] Clearly shows feng shui/fortune features

---

## 🚀 Alternative: Quick Template

If you want faster setup, I can provide exact coordinates:

### Copy This Layout:

```
Background: #086E56 gradient to #25826D
├─ App Icon: 80x80px at (40, 30)
├─ App Name: "風鈴命理" at (140, 35)
├─ Subtitle: "AI風水八字顧問" at (140, 65)
├─ Screenshot 1: 250x450px at (180, 25)
├─ Screenshot 2: 250x450px at (387, 25)
├─ Screenshot 3: 250x450px at (594, 25)
├─ Feature 1: "🏠 智能風水" at (100, 440)
├─ Feature 2: "📅 八字測算" at (320, 440)
├─ Feature 3: "💰 流年運程" at (540, 440)
├─ Feature 4: "❤️ 感情合盤" at (760, 440)
├─ Trust 1: "⭐ 98%用戶滿意" at (200, 470)
├─ Trust 2: "🔒 隱私安全" at (450, 470)
└─ Trust 3: "💯 90天退款保證" at (700, 470)
```
...
If Canva is too complex, alternative options:

1. **Hire on Fiverr:** Search "Google Play feature graphic" ($10-30, 1-2 days)
2. **Use Figma:** More professional, steeper learning curve
3. **Ask colleague:** Someone familiar with design tools
4. **Use PowerPoint:** Set slide to 1024x500px, export as PNG
...
**Next step:** Create screenshots (see SCREENSHOT_GUIDE.md)
