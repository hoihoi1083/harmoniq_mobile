# 🎨 Feature Graphic Design Specification for Google Play

## 📐 Technical Requirements

**File Name:** `feature_graphic_1024x500.png`
**Dimensions:** 1024 x 500 pixels (exact)
**Format:** 24-bit PNG (preferred) or JPEG
**Max File Size:** 1 MB
...
1. **Clearly communicate app purpose** - Feng Shui & Fortune telling advisor
2. **Show actual app functionality** - Not just promotional imagery
3. **Build trust** - Display credibility indicators
4. **Appeal to target audience** - Chinese-speaking users interested in Feng Shui
5. **Stand out** - Differentiate from generic lifestyle apps
...
│   風鈴命理       │  Chinese name: 28px bold
│  HarmoniQ       │  English name: 18px regular
...
- Position: Centered horizontally, 25px from top
- Add 15px spacing between screenshots
- Apply subtle drop shadow: 0px 4px 12px rgba(0,0,0,0.15)
...
- Color: White or #374A37 (depends on background)
...
4. ✅ 3 actual app screenshots
5. ✅ Feature list or icons
...
4. "New" or "Updated" badge if applicable
5. Award/recognition badges
...
4. Busy/cluttered background that distracts
5. Low-resolution or pixelated images
6. Misleading features not in the app
7. Competitive app names or logos
8. Copyrighted images without permission
9. Excessive text (keep it concise)
10. Promotional offers that expire
...
- Trust badges: Right-aligned, 350px from right
...
- [ ] App name in Chinese and English
- [ ] List of 4 key features
...
- [ ] Test at 50% zoom (how it appears in store)
...
- [ ] Name: `feature_graphic_1024x500.png`
- [ ] Test upload to Google Play Console
...
Requirements:
- Include our app icon and name (provided)
- Show 3 app screenshots (provided)
- Display features: 智能風水, 八字測算, 流年運程, 感情合盤
- Include trust badges: 98%用戶滿意, 隱私安全, 90天退款
- Use brand colors: #A3B116, #374A37, #086E56
- Professional, clean design
- Must follow Google Play guidelines

Deliverables:
- Source file (PSD/Figma)
- Final PNG (1024x500px, under 1MB)
...
**Recommended:** Create one version with both Chinese and English text to save time.
...
Monitor conversion rates in Google Play Console to see which performs best.

---

**Last Updated:** 2025-12-07
**Status:** Ready for design implementation
**Estimated Time to Complete:** 2-3 hours (DIY) or 3-5 days (outsourced)
