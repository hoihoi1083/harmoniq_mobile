            ...
            <div className="container mx-auto p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input name="birthDate" value={formData.birthDate} onChange={handleInputChange} className="w-full p-2 border rounded" />
                    </div>
                    <div>
                    ...
                    <div>
                        <button type="submit" className="px-4 py-2 bg-[#A3B116] text-white rounded">{isSubmitting ? t("submitting") : t("submit")}</button>
                    </div>
                </form>
            </div>
            <Footer />
