...
export async function POST(request) {
	...
	try {
		...
		// For mobile: use web URL that will be opened in system browser, then deep link back to app
		let successUrl = `${origin}/${locale}/success?session_id={CHECKOUT_SESSION_ID}&type=fortune&concern=${concernType}`;

		// Add mobile flag so success page knows to redirect back to app
		if (isMobileRequest) {
		...
		console.log("📱 Payment success URL:", { successUrl, isMobileRequest });
