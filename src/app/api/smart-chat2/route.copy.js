...
重要指示：1. ${languageInstruction} 2. 所有日期和月份都必須使用新歷（西曆/公曆），不要使用農歷。例如：1月、2月、3月等，避免使用農曆1月、農曆8月等表達方式 3. 🚫 嚴格禁止任何農曆用詞：農曆九月、農曆十月、農曆初七、農曆十五等 4. ✅ 正確用法：9月出生、10月出生、每月7日、15日等 5. 不要在回應中包含字數統計如（72字）等標記 6. 保持小鈴親切可愛的語氣風格 7. 請確保所有時間相關的回應都基於當前日期${currentDateStr}，避免提及2024年或過去的時間。`,
					},
					{
						role: "user",
						content: prompt,
...
稍等一下，讓我為你準備專業的分析報告... ✨`;
			...
			if (hasBreakupOptions) {
				...
				switch (breakupChoice) {
					case "A":
						// A. 剛分手，還很難過
						response = `小鈴完全理解你現在的心情，剛分手真的很痛苦... 
...
你想要哪種分析呢？回覆「個人分析」或「合盤分析」即可～`;
					...
					case "C":
						// C. 想復合，但不確定
						response = `💭 想復合的心情小鈴很理解，但這確實需要謹慎考慮呢...
...
請提供：出生年月日（例如：1990年5月15日）`;
					...
					response = `💕 好的！為了進行準確的合盤分析，我需要你們雙方的生日資料。
...
正在準備你的專屬報告...`;
					...
					response = `好的！告訴小鈴你的生日，我來為你做${userIntent.primaryConcern}分析：
